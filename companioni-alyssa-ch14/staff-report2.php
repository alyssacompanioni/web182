...
<!--	Author: Alyssa Companioni
		...
		Purpose:MySQL Exercise -> To complete the code so the program provides a table that shows the empID, first name, last name, job title, and hourly wage of all managers and accountants. 
-->
...
$userQuery = "SELECT * FROM personnel WHERE jobTitle = 'accountant' OR jobTitle='manager'";
