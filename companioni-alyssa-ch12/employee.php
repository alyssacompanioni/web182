...
<!--	
	...
	Date: 1.20.25
	File:    employee.php
	Purpose: Chapter 12 Exercise; To add code to display the employee's name and salary by using the ID submitted by the user to look up these values in two separate arrays. 
-->
...
<body>
    ...
    print("<p>Employee ".$empID." is ".$employees[$empID].", with a salary of $".number_format($salaries[$empID], 2));
	?>
